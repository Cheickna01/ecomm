          ...
          <Navbar expand='lg' light >
            ...
            <Collapse isOpen = {this.state.isOpen} navbar>
              <Nav vertical  className="text-left">
                ...
                <NavItem className='py-2'> 
                  <NavLink to="/category/4" ><i class="fas fa-laptop"></i> ordinateur</NavLink>
                </NavItem>
                <NavItem className='py-2'>
                  <NavLink to="/category/5" ><i class="fas fa-tv"></i> electronique</NavLink>
                </NavItem>
                <NavItem className='py-2'>
                  <NavLink to="/category/6" ><i class="fas fa-blender"></i> electromenager</NavLink>
                </NavItem>
              </Nav>
          </Collapse>
        </Navbar>
