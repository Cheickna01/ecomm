          ...
          <div className="product-img">
            <Link to={"/home/" + produits.id}>
              <img  
                ...
                src={produits.img.endsWith("jpg") || produits.img.endsWith("png") || produits.img.endsWith("jpeg") ? "/img"+produits.img : "https://tyshop.netlify.app/img/img/273800-p5v8j7-289.jpg"}
                alt="Produit"
              />
